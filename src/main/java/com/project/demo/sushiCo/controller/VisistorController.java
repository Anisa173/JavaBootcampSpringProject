...
public class VisistorController {
	...
	public String saveSelectedPreference(
			@ModelAttribute("restorantPreferenceForm") @Valid RestorantDto restorantSelected, Integer idRestorant,
		...
		if (((RestorantService) restorantSelected).getRestorantById1(idRestorant) == null) {
			...
			restService.createSelectRestorant(((RestorantService) restorantSelected).getRestorantById1(idRestorant),
					restorantSelected);
		}
