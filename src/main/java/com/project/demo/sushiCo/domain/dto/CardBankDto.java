...
import jakarta.validation.constraints.Size;
	...
	public class CardBankDto {
		...
		public CardBankDto(String BankId, Date valid_from, Date expiredTime, Integer cardSecurityCode, Integer userCardId,
		...
		public String toString() {
			return "CardBank[BankId = " + BankId + ",valid_from = " + valid_from + ",expiredTime = " + expiredTime
					+ ",cardSecurityCode = " + cardSecurityCode + ", userCardId = " + userCardId + ",cardHolderName = "
					+ cardHolderName + "]";
		}
