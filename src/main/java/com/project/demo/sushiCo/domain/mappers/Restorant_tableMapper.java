...
@Component
public class Restorant_tableMapper extends BaseMapper<RestorantTables, Restorant_tablesDto> {

	@Override
	public RestorantTables toEntity(Restorant_tablesDto dto) {
	...
	@Override
	public Restorant_tablesDto toDto(RestorantTables entity) {
	...
	@Override
	public RestorantTables toUpdate(Restorant_tablesDto dto, RestorantTables entity) {
