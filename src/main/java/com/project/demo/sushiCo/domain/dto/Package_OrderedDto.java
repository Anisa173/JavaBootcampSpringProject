...
@Builder
@AllArgsConstructor
public class Package_OrderedDto {
	private Integer id;
	...
	public Package_OrderedDto() {

	}

	public Package_OrderedDto(Integer id, StatusOrderSession statusOrderSession, Double sessionPayment,
